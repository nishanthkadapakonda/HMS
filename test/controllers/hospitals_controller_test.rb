...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { name: @hospital.name, phone: @hospital.phone, pin: @hospital.pin, place: @hospital.place } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { name: @hospital.name, phone: @hospital.phone, pin: @hospital.pin, place: @hospital.place } }
