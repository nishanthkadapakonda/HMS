...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { date: @slot.date, hospital_id: @slot.hospital_id, no_of_patients: @slot.no_of_patients, time_in: @slot.time_in, time_out: @slot.time_out, user_id: @slot.user_id } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { date: @slot.date, hospital_id: @slot.hospital_id, no_of_patients: @slot.no_of_patients, time_in: @slot.time_in, time_out: @slot.time_out, user_id: @slot.user_id } }
